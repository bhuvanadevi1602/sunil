                    ...
                    <div class="sk" style="border:3px solid black; padding: 0px 3px 0px 3px;">
                        <div class="d-flex justify-content-between pt-2" style="margin-right: 5px;">
                            <!-- <div class="row"> -->
                              ...
                              <p><b style="margin-right: 0px;">INVOICE NO:</b></p>
                                <p class="bordersss " style="margin-left:19px; min-width: 74px;"><b class="text-center" style=""><?php echo $bill_id; ?></b></p>
                                    ...
                                    <?php
                                        ...
                                        $sql="select * from normal_invoice  where bill_id='$bill_id' and financial_year='$finacial_year'  ";
                                        $result=mysqli_query($conn,$sql);
                      ...
                      <div class="col-lg-12 p-0">
                          ...
                          <div class="d-flex  justify-content-between pe-2">
                                                ...
                                                <p class="bordersss col-8 text-left text-uppercase"><b><?php echo $address_1; ?></b></span>
                          </div>
                            <div class="d-flex  justify-content-between pe-2">
                                                <h6 class="m-1 span-size col-3 mt-3"></h6>
                                                <p class="bordersss col-8 text-left text-uppercase"><b><?php echo $address_2; ?></b></span>
                          </div>
                                     <div class="d-flex  justify-content-between pe-1">
                                                <h6 class="m-1 span-size col-3">City:</h6>
                                                <p class="bordersss col-8 text-left text-uppercase">
                                  <b><?php echo $city; ?></b></span>
                          </div>
                          <div class="d-flex  justify-content-between pe-2">
                              <h6 class="m-1 span-size col-3">Phone no:</h6>
                              <p class="bordersss col-8 text-left text-uppercase"><b><?php echo $customer_contact; ?></b></span>
                          </div>
                       </div> 
                                  ...
                                  <div class="d-flex justify-content-between ">
                                                <!-- <div class="row "> -->
                                                    <!-- <div class="col-6"> -->
                                                        ...
                                                        <p class="bordersss col-4 text-center"><b><?php echo $appr_no; ?></b></span>
                         ...
                         <div class="d-flex ">
                                                <h6 class="m-1 span-size" style="padding-right:6px;white-space: nowrap;">GST NO:</h6>
                                                <p class="bordersss col-10 text-center"><b><?php echo $gst_num; ?></b></span>
                          </div>
                          <div class="d-flex ">
                                                <h6 class="m-1 span-size text-capitalize" style="padding-right:15px;">Terms:</h6>
                                                <p class="bordersss col-10 text-center"><b><?php echo $terms; ?></b></span>
                          </div>
                             ...
                             <div class="d-flex justify-content-between ">
                                                        ...
                                                        <p class="bordersss col-4 text-center"><b><?php echo $lr_no; ?></b></span>
                        
                    
                                      <h6 class="m-1 span-size text-capitalize">Date:</h6>
                                                        <p class="bordersss col-4 text-center"><b>
                                                            <?php 
                                                            if($lr_date!='')
                                                            {
                           ...
                           <div class="d-flex ">
                                                ...
                                                <p class="bordersss col-10 text-center mb-1"><b><?php echo $through; ?></b></span>
                          </div>
                            ...
                            <table class="table-design">
                                ...
                                <thead>
                                    <tr class="border-bottomss">
                                        <th class="text-center min-position"><span class="min-height-table"></span><span class="min-height-table-left"></span><span>SI.No</span></th>
                                        ...
                                        <th class="text-center min-position" style="white-space: nowrap;padding-left: 25px;"><span class="min-height-table"></span>HSN NO</th>
  ...
  <?php
   ...
   ?>
     <tr class="table-data">
         ...
         <td class="text-left text-uppercase"><span class="d-flex justify-content-between ms-1" style="margin-bottom: 0.11rem!important;">
             <b style='width: 30%;font-size: 14px;'>
             <?php 
               if($rec['meters']!='--')
               {
                   echo $rec['particular'].'</b><span style="width: 0%;">-</span><span class=" tdtdtd-position" style="width: 53%;">'.$rec['meters']; 
               }
               else
               {
                   echo $rec['particular'];
         ...
         <td class="text-center"><?php echo number_format($rec['amount'],2); ?></td>
     </tr>
   <?php
    }
   ?>
                      ...
                      <div class="">
                           ...
                           <div class="detailsss mt-1" style=" margin-left: 5px;">
                                  ...
                                  <div class="d-flex justify-content-between">
                                      <h6 class=" pt-3" style="margin: 5px;"><b style="white-space:nowrap;">NET AMOUNT : NO LESS</b></h6>
                                      <span class="line" style="height: 53px;"></span>
                                      <h6 class=" pt-3" style="margin: 5px;"><b style="white-space:nowrap;">TOTAL PIECES:</b><b style="margin-left: 5px;font-size:17px;"><?php echo $pieces_count ; ?></b></h6>
                                  </div>
                              </div>
                               <div class="">
                          <div class="fontsize">
                               ...
                               <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size3 font-smalls me-1">DISCOUNT AMOUNT</h6>
                               ...
                               <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size2 font-smalls">TOTAL DISCOUNT</h6>
                               ...
                               ?>
                               <div class="d-flex justify-content-between ht">
                                    <h6 class="rights-brs fonts-size3 font-smalls">IGST(<?php echo $igst; ?>%)</h6>
                                    <span class="box-design">
                                        <b class="me-3">
                                            <?php 
                               ...
                               ?>
                               <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size3 font-smalls">CGST(<?php echo $cgst; ?>%)</h6>
                                  <span class="box-design">
                                      <b class="me-3">
                                          <?php 
                                ...
                                <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size4 font-smalls">SGST(<?php echo $sgst; ?>%)</h6>
                                  <span class="box-design">
                                      <b class="me-3">
                                          <?php 
                               ...
                               <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size me-1"><b>TOTAL AMOUNT(<i class="fa fa-rupee-sign"></i>)</b></h6>
                               ...
                               <div class="d-flex justify-content-between ht">
                                  <h6 class="rights-brs fonts-size6">ROUND OFF</h6>
                               ...
                               <div class="d-flex justify-content-between ht">
                                  ...
                                  <span class="box-design"><b class="me-2" style="font-size:18px;font-weight: bold;"><?php echo number_format($net_amount,2); ?></b></span>
                               </div> 
