...
<head>
    <meta charset="utf-8" />
    <title>Debit Report Bill | Sunil Traders</title>
    ...
    <div class="page-wrapper ">
        ...
        <div class="page-content-tab ">
            <div class="container-fluid " style="margin-top: 10px;">
                ...
                <div class="row">
                    <div class="col-lg-12 table-nth-table "  id="break"  style="font-family: 'PT Serif', serif !important;">
                        <table class="table tablesss"  id="invoice-table" >
                            <thead class=""  style="border:1px solid;">
                                <tr>

                                    <th class="text-center pt-1 pb-1" colspan="10">
                                
                                        <h4 style="line-height: 10px;"><b><u>DEBIT REPORT</u> </b></h4></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="table-title ">
                                    ...
                                    <th class="text-center" style="width: 30px;">DEBIT NO</th>
                            ...
                            <tbody >
                                ...
                                <tr class="table-titless invoice_line" >
                                    ...
                                    <td class="text-center"><?= $purchase['debit_note_bill_id'] ?></td>
                        ...
                        <tfoot >
                                ...
                                <tr class="table-titless font-bold ">
                                    ...
                                    <td class="text-center" >
                                     ...
                                     <td class="text-end" colspan="1" ></td>
                                    <td class="text-end" colspan="1" ></td>
                                    <!--<td class="text-end" colspan="2" style="min-width: 202px;"></td>-->
                                    <td class="text-center">
                                        <!--<//?= number_format($totalNetAmount,2,'.',',') ?>-->
