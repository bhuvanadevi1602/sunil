<?php 
    ...
    if(isset($_POST['filter'])){
        $fdate = $_REQUEST['fdate'];
        $toDate = $_REQUEST['toDate'];
        header("Location: debitNoteReport.php?fdate=$fdate&toDate=$toDate");
    }
    ...
    //     if($conn->query($sql)){
    //         header('location: debitNoteReport.php?meg=Deleted Successfully');
    //     }
    // }
...
<head>
    <meta charset="utf-8" />
    <title>Report Debit Note | Sunil Traders</title>
...
<!-- <body id="body" onload="window.print()" class="dark-sidebar"> -->
                    ...
                    <div class="col-12 " >
                        <div class="card">
                            <div class="card-header row">
                                <h4 class="card-title col-11">Debit Note Report</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table mt-3" id="datatable_1">
                                        <thead class="thead-light p-3" style=" white-space: nowrap;">
                                          <tr>
                                        ...
                                        <tbody style=" white-space: nowrap;">
                                            <?php 
                                               if($fdate){
                                                ...
                                                $sql2 = "SELECT * FROM `debit_note` WHERE `createdAt` >= '$fdate' AND `createdAt` <= '$toDate' ORDER BY debit_note_id DESC";
                                                // $sql2 = "SELECT * FROM debit_note WHERE `createdAt` LIKE '%$month%' ORDER BY debit_note_id ASC";
                                                }else{
                                                    $sql2 = "SELECT * FROM debit_note ORDER BY debit_note_id DESC";
                                                }
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        if($fdate){
                                                            $sql2 = "SELECT * FROM `debit_note` WHERE `createdAt` >= '$fdate' AND `createdAt` <= '$toDate' ORDER BY debit_note_id ASC";
                                                            // $sql2 = "SELECT * FROM debit_note WHERE `createdAt` BETWEEN '$fdate' AND '$toDate' ORDER BY debit_note_id ASC";
                                                        // $sql2 = "SELECT * FROM debit_note WHERE `createdAt` LIKE '%$month%' ORDER BY debit_note_id ASC";
                                                        }else{
                                                            $sql2 = "SELECT * FROM debit_note ORDER BY debit_note_id DESC";
  ...
  <?php include('footer.php') ?>
    ...
    <script>
        ...
        function printDiv(){;
            window.open("debitNoteReportBill.php?fdate=<?= $fdate?>&toDate=<?= $toDate ?>");   
        }
    </script>
