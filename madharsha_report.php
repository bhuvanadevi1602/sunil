                    ...
                    <div class="col-12 " >
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title col-11">Sales Invoice Report</h4>
...
<script>
    $(document).ready(function(){
        ...
        $('#filter_invoice').on('click',function(){
             ...
             table.ajax.url('ajax_request.php?action=fetch_madharsha_report&from_date='+from_date+'&to_date='+to_date).load();
             
             table.ajax.reload();
             
             $.ajax({
                 url:'ajax_request.php?action=fetch_sales_invoice_subtotal',
                 type:'POST',
                 dataType:'json',
    ...
    $('#print_report').on('click',function(){
        ...
        window.open('sales_invoice_report_bill.php?from_date='+from_date+'&to_date='+to_date);
