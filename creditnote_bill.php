...
<?php 
    $sql = "SELECT * FROM credit_note WHERE credit_note_bill_id = '$id'";
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="formss card mb-0" id="print_content">
                    <div class="sk" style="border:3px solid black; padding: 0px 4px 0px 4px;">
                            ...
                            <!-- <div class="row"> -->
                                ...
                                <div class="col-sm-3" style="text-align: end;margin-right: 5px; padding-right: 5px;">
                                    ...
                                    <div class="d-flex  mt-0 mb-0">
                                        <p><b>CREDIT NO:</b></p>
                                          <p class="bordersss text-center" style="margin-left:5px; min-width: 74px;"><b class="text-center"><?= $debitNoteTable['credit_note_bill_id'] ?></b></p>
                                    </div>
                        ...
                        <div class="containers 11">
                            <div class="col-lg-12 p-0">
                                <p class="text-center top-bottom-border"><b style="font-size: 20px;">CREDITNOTE</b></p>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex ">
                                        <div class="right-border" style="width: -webkit-fill-available;">
                                            ...
                                            <!-- <div class="d-flex  mt-3">
                                                ...
                                                <span class="span-tags me-3" style="padding-left: 42px;"></span>
                                            </div>
                                            <div class="d-flex  mt-3">
                                                <h6 class="m-1 span-size">City:</h6>
                                                <span class="span-tags me-3" style="padding-left:67px"></span>
                                            </div>
                                            <div class="d-flex  mt-3">
                                                <h6 class="m-1 span-size" style="flex:none;">Phone no:</h6>
                                                <span class="span-tags me-3" style=" padding-left: 38px;"></span>
                                            </div> -->
                                        </div>
                                        ...
                                        if($dat=="0000-00-00"){
                                            ...
                                            <div class="d-flex mt-1">
                                                <h6 class="m-1 span-size" style="padding-right:5px;white-space:nowrap;"><b>GST NO:</b></h6>
                                            ...
                                            <div class="d-flex mt-1">
                                                <h6 class="m-1 span-size " style="padding-right:15px;"><b>Terms:</b></h6>
                                                <p class="bordersss col-10 text-center">
                                                    <!--<b>-->
                                            ...
                                            <div class="d-flex justify-content-between mt-1">
                                                <!-- <div class="row "> -->
                                                    <!-- <div class="col-6"> -->
                                                        <h6 class="m-1 span-size" style="padding-right:15px"><b>L/R:</b></h6>
                                                        <p class="bordersss col-4 text-center" >
                                                            <!--<b>-->
                                                            <?= $debitNoteTable['LR'] ?>
                                                            <!--</b>-->
                                ...
                                <div class="col-12 d-flex justify-content-between">
                                    <!-- <div class="row d-flex"> -->
                                        <div class="col-6 d-flex mt-1 mb-1" style="border-top: 1px solid;margin-left: -2px;">
                                            <h6 class="m-1 span-size col-sm-4" style="white-space: nowrap;">CREDIT BILL NO:</h6>
                                            <p class="bordersss col-sm-4 mt-1 text-center">
                                                <b>
                                        ...
                                        <?php
                                        $dat=$debitNoteTable['creditBillDate'];
                                        if($dat=="0000-00-00"){
                                            $dates1="";
                                        }
                                        else{
                                        ...
                                        ?>
                                        <div class="col-6 d-flex mt-1 mb-1" style="border-top: 1px solid;margin-left: -2px;">
                                            <h6 class="m-1 span-size col-sm-4" style="white-space: nowrap;">CREDIT BILL DATE:</h6>
                                            <p class="bordersss col-sm-4 mt-1 text-center">
                                                <b>
                                                <?= $dates1 ?>
                                                </b>
                ...
                <div class="card1">
                            ...
                            <table class="table-design">
                                ...
                                <thead>
                                    <tr class="border-bottomss">
                                        ...
                                        <th class="text-center min-position"><span class="min-height-table"></span>MTS</th>
                                        <th class="text-center min-position"><span class="min-height-table"></span>PCS</th>
                                        <th class="text-center min-position"><span class="min-height-table"></span>RATE</th>
                                        <th class="text-center min-position"><span class="min-height-table"></span>AMOUNT</th>
                                    </tr>
                                </thead>   
                                <?php 
                                    $sql1 = "SELECT * FROM credit_note_product WHERE credit_note_id = '$id' and financialYear like '%$years%'";
                                    ...
                                    <tr class="table-data">
                                        ...
                                        <td class=""><span class="ms-2 d-flex justify-content-between"><b style='width: 30%;'><?=$productTable['particulars'] ."</b><span style='width: 0%;'>-</span><span class='' style='width: 53%;'>". $productTable['meter'] ?></span></span></td>
                                        ...
                                        <td class="text-center"><?= number_format($productTable['amount'],2) ?></td>
                        ...
                        <div class="">
                            <div class="d-flex justify-content-between tt">
                                <div class="detailsss mt-1" style=" margin-left: 5px;">
                                    ...
                                    <!--   </table1>-->
                                    <!--   </div>-->
                                   <h6 class="bank-details mb-0 text-center" style="width:401px;">BANK DETAILS</h6>
                                    <div class="d-flex bank-detailss" style="width:401px;">
                                    <div class="rrbb" style="width:401px;">
                                       <p style="white-space:nowrap;"><b>Bank:</b>Central Bank of India
                                       Sowcarpet Branch,chennai</p>
                                       <p><b>Acc no: </b> 8745965123</p>
                                       <p><b>IFSC Code: </b> 2536984512</p>
                                    </div>  
                                    <!--<div class="llbb" style="width:266px;">-->
                                    <!--   <p><b>Bank:</b>ICIC Bank-->
                                    <!--   NungamBakkam Branch,Chennai</p>-->
                                       <!--<p>NO 37,Old No 13,Godown Street,</p>-->
                                       <!--<p>Tamil Nadu-600001</p>-->
                                    <!--   <p style="white-space: nowrap;"><b>Acc No: </b> 000905019040</p>-->
                                    <!--   <p style="white-space: nowrap;"><b>IFSC Code: </b> ICICOOO0009</p>-->
                                    <!--</div>   -->
                                 </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                       ...
                                       <!--<span class="line" style="height: 66px;"></span>-->
                                        <h6><b>TOTAL PIECES: <?= $totalPrice ?></b></h6>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="fontsize">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="pt-2 text-center box-design "><?= $debitNoteTable['subTotal'] ?></span>
                                        </div>
                                        <!--<div class="d-flex justify-content-between">-->
                                        ...
                                        <!--</div> -->
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-2 fonts-size7" style="left: 80px;"><b>IGST(<?= $debitNoteTable['IGST'] ?>%)</b></h6>
                                            <span class="pt-2 text-center box-design "><?= ($debitNoteTable['IGSTTax'])? $debitNoteTable['IGSTTax'] : "---" ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-3 fonts-size7" style="left: 70px;"><b>CGST(<?= $debitNoteTable['CGST'] ?>%)</b></h6>
                                            <span class="pt-2 text-center box-design "><?= ($debitNoteTable['CGSTTax'])? $debitNoteTable['CGSTTax'] : "---" ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-4 fonts-size7" style="left: 70px;"><b>SGST(<?= $debitNoteTable['SGST'] ?>%)</b></h6>
                                            <span class="pt-2 text-center box-design "><?= ($debitNoteTable['SGSTTax'])? $debitNoteTable['SGSTTax'] : "---" ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-5 fonts-size6"><b>TOTAL AMOUNT(RS)</b></h6>
                                            <span class="pt-2 text-center box-design "><?=$debitNoteTable['total'] ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-6 fonts-size7"><b>ROUND OFF</b></h6>
                                            <span class="pt-2 text-center box-design "><?=$debitNoteTable['roundOff'] ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="rights-brs pos-right-7 fonts-size6"><b>NET AMOUNT(RS)</b></h6>
                                            <span class="pt-2 text-center box-design "><h5><b><?=number_format($debitNoteTable['netAmount'],2)  ?></b></h5></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="">
                            ...
                            <div class="text-center top-bottom-border">
                                <h6 style="margin:6px;"><b style="font-size:17px;">All Remittance to be Made Favouring SUNIL TRADERS, Chennai-600001</b></h6>
                            </div>
                           <div class="containers mb-0">
                                <div class=" mt-0 mb-0">
                                    <div class="d-flex justify-content-between " style="line-height: 15px;">
                                        <div class="">
