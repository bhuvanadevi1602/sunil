                    ...
                    <div class="col-12 " >
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title col-11">Madharsha & Show Room Report</h4>
...
<script>
    $(document).ready(function(){
        ...
        $('#filter_invoice').on('click',function(){
             ...
             table.ajax.url('ajax_request.php?action=fetch_madharsha_showroom&from_date='+from_date+'&to_date='+to_date).load();
             table.ajax.reload();
             
             $.ajax({
                 url:'ajax_request.php?action=fetch_madharsha_showroom_subtotal',
                 type:'POST',
                 dataType:'json',
    ...
    $('#print_report').on('click',function(){
        ...
        window.open('madharsha_showroom_report_bill1.php?from_date='+from_date+'&to_date='+to_date);
