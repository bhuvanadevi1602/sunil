                            ...
                            //   print_r($m." ".$k);die();
                                 ...
                                 for ($i = 1; $i <= $k; $i++) {
                                    //   $d++;
                                        $s = $m * 25;
                                        $s1 = (($m - 1) * 25)+1;
                                            $cos = "select * from (select * from purchase where `invoiceDate` LIKE '%$month%' order by purchaseId desc limit 0,$s) as subt ;";
                                ...
                                ?>
                                                <tr class="table-titless  invoice_line">
                                                    ...
                                                    <td class="text-center ">
                                                        ...
                                                        <?php
                                                        if ($rec['IGST'] != '') {
                                                            $igst_amount = str_replace(',', '', $rec['IGST']);
                                                    ...
                                                    <td class="text-center text-capitalize"><?php echo $rec['purchaseId']; ?></td>
                                          ...
                                          $c=($m-1);
                                           $cos = "select sum(amount) as v,sum(SGST) as sgst,sum(CGST) as cgst,sum(IGST) as igst,sum(netAmount) as net_amount from (select amount,CGST,IGST,SGST,netAmount from purchase where `invoiceDate` LIKE '%$month%' order by purchaseId desc limit $c,$s) as subt;";
                                //   print_r($cos);die();
                                           $execos = mysqli_query($conn, $cos);
                                           ...
                                           <tr class="table-titless font-bold">
                                                ...
                                                <td class="text-center" style="border: 1px solid black;"><?=number_format($nos['sgst'],2) ?></td>
                                                <td class="text-center" style="border: 1px solid black;"><?=number_format($nos['cgst'],2) ?></td>
                                                <td class="text-center" style="border: 1px solid black;"><?=number_format($nos['igst'],2) ?></td>
                                                <td class="text-center" style="border: 1px solid black;"></td>
                                                <td class="text-center" style="border: 1px solid black;"></td>
                                   ...
                                   // $cos="select * from  comboset_invoice_final where created_at >= '2023-04-01' and created_at <= '2023-04-30'";
                                               ...
                                               <td class="text-endsss" colspan="3" style="border: 1px solid black;"><b>OVER ALL TOTAL</b></td>
                                                <td class="text-center" style="border: 1px solid black;">
                                                    ...
                                                    // echo $tot_amount;
                                                    echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $amount);
                                                    ?>
                                                </td>
                                                <td class="text-center" style="border: 1px solid black;">
                                                    ...
                                                    if ($totalCGST != '') {
                                                        ...
                                                        echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $totcgst);
                                                    } else {
                                                        echo  "---";
                                                    }
                                                    ?>
                                                ...
                                                <td class="text-center" style="border: 1px solid black;">
                                                    ...
                                                    if ($totalSGST != '') {
                                                        ...
                                                        echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $totsgst);
                                                    } else {
                                                        echo  "---";
                                                    }
                                                    ?>
                                    ...
                                    //   $d++;
                                        ...
                                        $s1 = (($m - 1) * 25)+1;
                                         if ($m == 1) {
                                             $c=($m-1);
                                            $cos = "select * from (select * from purchase where `invoiceDate` LIKE '%$month%' order by purchaseId desc limit $c,$s) as subt ;";
                                                    // print_r($cos);die();
                                        // $cos="select * from comboset_invoice_final where created_at >= '2023-04-01' and created_at <= '2023-04-30'";
                                            $execos = mysqli_query($conn, $cos);
                                            while ($rec = mysqli_fetch_assoc($execos)) {
                                ...
                                ?>
                                    ...
                                    <td class="text-center"></td> -->
                                            ...
                                            <?php 
                                                ...
                                                $d1=($m-1)*25;
$d=$d1+1;
                                            $cos = "select * from (select * from purchase where `invoiceDate` LIKE '%$month%' order by purchaseId desc limit $s1,$s) as subt;";
                                                // print_r($cos);die();
                                    // $cos = "select * from (select * from comboset_invoice_final where created_at >= '$from_date' and created_at <= '$to_date' order by id desc limit $s1,$s) as subt;";
                                            ...
                                            <?php
                                             ...
                                             $cos = "select sum(amount) as v,sum(SGST) as sgst,sum(CGST) as cgst,sum(IGST) as igst,sum(netAmount) as net_amount from (select amount,CGST,IGST,SGST,netAmount from purchase where `invoiceDate` LIKE '%$month%' order by purchaseId desc limit $s1,$s) as subt;";
                                            //  $cos = "select sum(total) as v,sum(sgst_amount) as sgst,sum(cgst_amount) as cgst,sum(igst_amount) as igst,sum(net_amount) as net_amount from (select total,cgst_amount,igst_amount,sgst_amount,net_amount from comboset_invoice_final where created_at >= '$from_date' and created_at <= '$to_date' order by id desc limit $s1,$s) as subt;";
                                            $execos = mysqli_query($conn, $cos);
                                            $nos = mysqli_fetch_assoc($execos);
                                            ?>
...
<!--                                ?>-->
<!--                                <tr class="table-titless  invoice_line <?php echo ($i==25) ?'page1':''?>" >-->
<!--                                    <td class="text-center"><?= $i ?></td>-->
...
<!--                                         <?php -->
<!--                                            $total=number_format($purchase['amount'],2);-->
<!--                                            $tot_amount=str_replace( ',', '', $total );-->
...
<!--                                    </td>-->
<!--                                    <td class="text-center">-->
                                        <!--<//?= ($purchase['CGST']) ? number_format($purchase['CGST'],2) : "---" ?>-->
<!--                                        <?php -->
<!--                                        if($purchase['CGST']!='') -->
<!--                                        {-->
<!--                                            $cgst_amount=str_replace( ',', '', $purchase['CGST'] );-->
<!--                                            echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $cgst_amount);-->
<!--                                        }-->
<!--                                        else-->
<!--                                        {-->
...
<!--                                    </td>-->
<!--                                    <td class="text-center">-->
                                        <!--<//?= ($purchase['SGST']) ? number_format($purchase['SGST'],2) : "---" ?>-->
<!--                                        <?php -->
<!--                                        if($purchase['SGST']!='') -->
<!--                                        {-->
<!--                                            $sgst_amount=str_replace( ',', '', $purchase['SGST'] );-->
<!--                                            echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $sgst_amount);-->
<!--                                        }-->
<!--                                        else-->
<!--                                        {-->
...
<!--                                    </td>-->
<!--                                    <td class="text-center">-->
                                        <!--<//?= ($purchase['IGST']) ? number_format($purchase['IGST'],2) : "---" ?>-->
<!--                                        <?php -->
<!--                                        if($purchase['IGST']!='') -->
<!--                                        {-->
<!--                                            $igst_amount=str_replace( ',', '', $purchase['IGST'] );-->
<!--                                            echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $igst_amount);-->
<!--                                        }-->
<!--                                        else-->
<!--                                        {-->
...
<!--                                        <?php -->
<!--                                        if($purchase['netAmount']!='') -->
<!--                                        {-->
<!--                                            $net_amount=str_replace( ',', '', $purchase['netAmount'] );-->
<!--                                            echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $net_amount);-->
<!--                                        }-->
<!--                                        else-->
<!--                                        {-->
