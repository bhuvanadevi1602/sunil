      ...
      <div class="page-content-tab">
                <div class="container-fluid">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                    ...
                                    <div class="row mt-1">
                                        <?php
                                            $sql="SELECT bill_id FROM cash_bill_final ORDER BY cash_id DESC LIMIT 1";
                                        ...
                                        <div class="col-sm-2 ">
                                            ...
                                            <input id="bill_id" type="text" value="<?php echo $bilL_id1; ?>" name="bill_id" class="add_entry form-control cardss mt-1" >
                                        </div>
                                        <div class="col-sm-2 ">
                                            
                                            <select name="yearpicker" id="yearpicker" class="add_entry form-control cardss "></select>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                            <!--<label class="control-label mb-1"><b>Customer Details</b></label>-->
                                                   ...
                                                   <div class="col-sm-4 mb-1">
                                                            ...
                                                            <input id="customer_name" type="text" value="" name="customer_name" class="add_entry form-control cardss enter mt-" placeholder="Customer Name" >
                                                        </div>
                            
                                                    <div class="col-sm-4 ">
                                                            <!--<label class="">Phon Number</label>-->
                                                            <input id="gst_no" type="text" value="" name="gst_no" class="add_entry form-control cardss enter mt-" placeholder="GSTNo" >
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                            <!--<label class="">HSN</label>-->
                                                            <input id="address-1" type="text" value="" name="address1" class="add_entry form-control enter cardss mt-" placeholder="Address-1" >
                                                    </div>
                                       ...
                                       <div class="row mt-0">
                                            <!--<label class="control-label mb-1"><b>Customer Details</b></label>-->
                                                   <div class="col-sm-4 mb-1">
                                                            ...
                                                            <input id="address-2" type="text" value="" name="Address-2" class="add_entry form-control cardss enter mt-" placeholder="Address-2" >
                                                        </div>
                            
                                                    <div class="col-sm-4 ">
                                                            <!--<label class="">Phon Number</label>-->
                                                            <input id="city" type="text" value="" name="City" class="add_entry form-control cardss enter mt-" placeholder="City" >
                                                    </div>
                                                       <div class="col-sm-4 mb-2">
                                                            <!--<label class="">HSN</label>-->
                                                            <input id="contact" type="text" value="" name="contact" class="add_entry form-control cardss enter mt-" placeholder="Phone" >
                                                    </div>
                                    ...
                                    <div id="particular_detail">
                                        ...
                                        <div class="row">
                                        <div class="col-lg-3 ">
                                         <div class="col-sm-3 form-control cardss  measurement_unit">
                                               ...
                                               <div class="col-lg-2 mt-1">
                                                    <div class="input-group">
                                                        <div class="input-group-text a">Particular</div>
                                                            <input type="text" class="add_entry form-control enter" id="particular" name="particular" placeholder="Particular" required>
                                                        </div>
                                                </div>  
                                                
                                                 <div class="col-lg-2 mt-1">
                                                    <div class="input-group">
                                                        <div class="input-group-text b">HSN</div> 
                                                        <input type="text" class="add_entry form-control enter" id="hsn" name="hsn" placeholder="HSN" required>
                                                    </div>
                                                  </div> 
                                                <div class="col-lg-2 mt-1">
                                                    <div class="input-group">
                                                        <div class="input-group-text b">Meters</div> 
                                                        <input type="number" class="add_entry form-control enter" id="meter" name="meter" placeholder="Meters" required>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-lg-2 mt-1" >
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="add_entry form-control enter" id="pieces" name="pieces" placeholder="Pieces" required>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-lg-2 mt-1">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="add_entry form-control enter" id="rate" name="rate" placeholder="Rate" required>
                                                    </div>
                                                </div> 
                                        ...
                                        <div class="row">
                                          <div class="col-md-4">
                                            ...
                                            <div class="offset-md-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="gst_status" id="gst_noo" value="gst_yes">
   ...
   if(key == 13)
    {
        ...
        $.ajax({
            url:'ajax_request.php?action=add_cash_bill_entry',
            type:'POST',
            dataType:'json',
            data:{'bill_id':bill_id,'cus_name':cus_name,'gst_no':gst_no,'address_1':address_1,'address_2':address_2,'city':city,'cus_contact':contact,'measurement_unit':measurement_unit,'particular':particular,'meter':meter,'hsn':hsn,'pieces':pieces,'rate':rate,'amount':amount,'yearpicker':yearpicker},
            success:function(result_job)
            {
                if(result_job.status==1)
                {
                    ...
                    for(var i=0;i<count;i++)
                    {
                        ...
                        $('#particulars_row').append('<tr id="row_'+result_job.data[i].id+'"><td id="td_particular">'+result_job.data[i].particular+'</td><td id="td_meter">'+meters.toFixed(2)+'</td><td id="td_pieces">'+result_job.data[i].pieces+'</td><td id="td_rate">'+result_job.data[i].rate+'</td><td id="td_amount_'+i+'">'+rest_amount.toFixed(2)+'</td><td><button class="btn btn-outline-primary btn-sm mb-1 mb-xl-0 remove_particular1" id="'+result_job.data[i].id+','+result_job.data[i].bill_id+'">Remove</button></td></tr>')
                    ...
                    $('.remove_particular1').on('click',function(){
                        ...
                        $.ajax({
                            ...
                            type:'POST',
                            dataType:'json',
                            data:{'action':'delete_cash_bill_entry','id':id,'bill_id':bill_id},
                            success:function(result_job){
...
$('.print_bill').click(function(){
    ...
    var address_1=encodeURIComponent($('#address-1').val());
    var address_2=encodeURIComponent($('#address-2').val());
    var city=$('#city').val();
    ...
    var net_amount=$('#net_amount').val();
     ...
     window.open('bill_1.php?action=bill_printed&bill_id='+bill_id+'&customer_name='+customer_name+'&customer_contact='+customer_contact+'&gst_no='+gst_no+'&address_1='+address_1+'&address_2='+address_2+'&city='+city+'&sub_total='+sub_total+'&discount_amount='+discount_amount+'&total_amount='+total_amount+'&cgst='+cgst+'&sgst='+sgst+'&igst='+igst+'&net_amount='+net_amount+'&payment_mode='+payment_mode+'&financial_year='+yearpicker);
...
$('#save_refresh').on('click',function(){
    ...
    $.ajax({
        ...
        type:'POST',
        dataType:'json',
        data:{'action':'cash_bill_printed','bill_id':bill_id,'customer_name':customer_name,'address_1':address_1,'address_2':address_2,'city':city,'customer_contact':customer_contact,'payment_mode':payment_mode,'gst_no':gst_no,'sub_total':sub_total,'discount_amount':discount_amount,'total_amount':total_amount,'cgst':cgst,'sgst':sgst,'igst':igst,'net_amount':net_amount,'yearpicker':yearpicker},
        success:function(result_job)
        {
            if(result_job.status==1)
            {
...
//     {
        ...
        $.ajax({
            url:'ajax_request.php',
            type:'POST',
            data:{'action':'fetch_cash_bills','bill_id':bill_id,'yearpicker':yearpicker},
            dataType:'json',
            success:function(result_job){
                $('#particular').focus();
                $('#customer_name').val('');
                ...
                if(result_job.status==1)
                {
                    ...
                    for(var i=0;i<count;i++)
                    {
                       ...
                       if(meter==0)
                       {
                            $('#particulars_row').append('<tr id="row_'+result_job.data[i].id+'"><td>'+result_job.data[i].particular+'</td><td>---</td><td>'+result_job.data[i].pieces+'</td><td>'+result_job.data[i].rate+'</td><td>'+result_job.data[i].amount+'</td><td><button class="btn btn-outline-primary btn-sm mb-1 mb-xl-0 remove_particular" id="'+result_job.data[i].id+','+result_job.data[i].bill_id+'">Remove</button></td></tr>')   
                       }
                       else
                       {
                            $('#particulars_row').append('<tr id="row_'+result_job.data[i].id+'"><td>'+result_job.data[i].particular+'</td><td>'+meter.toFixed(2)+'</td><td>'+result_job.data[i].pieces+'</td><td>'+result_job.data[i].rate+'</td><td>'+result_job.data[i].amount+'</td><td><button class="btn btn-outline-primary btn-sm mb-1 mb-xl-0 remove_particular" id="'+result_job.data[i].id+','+result_job.data[i].bill_id+'">Remove</button></td></tr>')    
                       }
                    
                       
                    }
                       $('#customer_name').val(result_job.data[0].customer_name);
                       $('#gst_no').val(result_job.data[0].gst_no);
                       $('#contact').val(result_job.data[0].customer_contact);
                       $('#address-1').val(result_job.data[0].address_1);
                       $('#address-2').val(result_job.data[0].address_2);
                       ...
                       $('.remove_particular').on('click',function(){
                        ...
                        $.ajax({
                            ...
                            type:'POST',
                            dataType:'json',
                            data:{'action':'delete_cash_bill_entry','id':id,'bill_id':bill_id,'yearpicker':yearpicker},
                            success:function(result_job){
                                 ...
                                 $('#update_refresh').on('click',function(){
                                    ...
                                    var net_amount=$('#net_amount').val();
                                            ...
                                            type:'POST',
                                            dataType:'json',
                                            data:{'action':'update_cash_bill','bill_id':bill_id,'customer_name':customer_name,'customer_contact':customer_contact,'payment_mode':payment_mode,'sub_total':sub_total,'discount_amount':discount_amount,'total_amount':total_amount,'cgst':cgst,'sgst':sgst,'igst':igst,'igst_amount':igst_amount,'net_amount':net_amount,'yearpicker':yearpicker},
                                            success:function(result_job)
                                            {
                                                if(result_job.status==1)
                                                {
