                            ...
                            <div class="card-body">
                                <div class="table-responsive" >
                                    <table class="table">
                                        ...
                                        <tbody id="particulars_rows">  </tbody>
                                    </table>
            ...
            success:function(result_job){
               ...
               if(result_job.data[0].discount!='')
                   ...
                   $('#row_'+id+'').load(location.href+' #row_'+id+''); 
                    ...
                    else if(result_job.status==0 && result_job.data[0].hsn==''){
                                                            //  alert("hello")
