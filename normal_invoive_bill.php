...
<body id="body" class="auth-page" style="background-image: url('assets/images/p-1.png'); background-size: cover; background-position: center center;" onload="myfunction()">
  ...
  <div class="container mt-5">
      <div class="row">
          <div class="col-lg-8 offset-lg-2">
              <div class="border-fulls">
                 <div class="formss card" id="print_content">
                     
                     <div class="sk" style="padding: 0px 0px 23px 0px;">
                  <div class="d-flex justifysss">
                      ...
                      <div class="" style="text-align: end;margin-right: 5px;">
                           ...
                           <div class="d-flex justify-content-between mt-2 mb-2">
                              <p><b>INVOICE NO:</b></p>
                              <p class="bordersss"><b class="text-center"><?php echo $bill_id; ?></b></p>
                           </div>
                           <div class="d-flex justify-content-between mt-2 mb-2">
                              <p><b>DATE:</b></p>
                      ...
                      <div class="d-flex ll">
                         <div class="right-border">
                          <div class="d-flex mt-3 justify-content-between">
                              ...
                              <span class="span-tags me-3"><?php echo $customer_name; ?></span>
                          </div>
                          <div class="d-flex justify-content-between mt-3">
                              <h6 class="m-1 span-size">Address</h6>
                              <span class="span-tags me-3"><?php echo $address_1.$address_2; ?></span>
                          </div>
                          <div class="d-flex justify-content-between mt-3">
                              <h6 class="m-1 span-size">City</h6>
                              <span class="span-tags me-3"><?php echo $city; ?></span>
                          </div>
                          <!--<div class="d-flex justify-content-between mt-3">-->
                         ...
                         <div class="">
                          <div class="d-flex justify-content-between  mt-3">
                              ...
                              <span class="span-tags1"><?php echo $appr_no; ?></span>
                              </div>
                                <div class="d-flex justify-content-between">
                                <h6 class="m-1 span-size">Date:</h6>
                              <span class="span-tags1"><?php echo $appr_date; ?></span>
                              </div>
                              </div>
                          </div>
                          <div class="d-flex  mt-3">
                              <h6 class="m-1 span-size"  style="flex:none;">GST NO:</h6>
                              <span class="span-tags gst" style="padding-left: 2px;"><?php echo $gst_num; ?></span>
                          </div>
                          <!--<div class="d-flex   mt-3">-->
                          ...
                          <!--</div>-->
                           <div class="d-flex  mt-3 mb-3">
                              <div class="d-flex">
                                <div class="d-flex justify-content-between">
                              <h6 class="m-1 span-size">Terms:</h6>
                              <span class="span-tags1" style="padding-left: 2px;"><?php echo $terms; ?></span>
                              </div>
                                <div class="d-flex justify-content-between">
                                <h6 class="m-1 span-size">Through:</h6>
                              <span class="span-tags1"><?php echo $through; ?></span>
                              </div>
                              </div>
                          </div>
                          ...
                          <div class="d-flex  mt-3 mb-3">
                              ...
                              <span class="span-tags1" style="padding-left: 25px;"><?php echo $lr_no; ?></span>
                              </div>
                                <div class="d-flex justify-content-between">
                                <h6 class="m-1 span-size">Date:</h6>
                              <span class="span-tags1"><?php echo $lr_date; ?></span>
                              </div>
                              </div>
                          </div>
                          <!--  <div class="d-flex mt-3 mb-3">-->
                          <!--    <h6 class="m-1 span-size ">Through:</h6>-->
                          <!--    <span class="span-tags gst"></span>-->
                          <!--</div>-->
 ...
 <div class=" table-responsive">        
   ...
   <?php
    $sql="select * from normal_invoice  where bill_id='$bill_id' and bill_status=0";
    $result=mysqli_query($conn,$sql);
    $i=1;
   ...
   ?>
            <tr class="table-data">
             <td><?php echo $i++; ?></td>
             <td class="text-center"><?php echo $rec['particular'].'-'.$rec['meters']; ?></td>
                           ...
                           <!--   </div>-->
                                 ...
                                 <div class="d-flex">
                                  ...
                                  <div class="d-flex justify-content-between">
                                      ...
                                      <h6>TOTAL PIECES:<b><?php echo $pieces_count ; ?></b></h6>
                                  </div>
                              </div>
                               <div class="">
                          <div class="fontsize">
                               <div class="d-flex justify-content-between">
                                  ...
                                  <span class="box-design"><?php echo $sub_total; ?></span>
                               </div> 
                               ...
                               <div class="d-flex justify-content-between">
                                    ...
                                    <span class="box-design"><?php echo $igst_amount=((float)$total_amount/100)*$igst; ?></span>
                                </div>
                                <?php
                               }
                               ...
                               <div class="d-flex justify-content-between">
                                  ...
                                  <span class="box-design"><?php echo $cgst_amount=((float)$total_amount/100)*$cgst; ?></span>
                                </div> 
                                <div class="d-flex justify-content-between">
                                  <h6 class="rights-brs fonts-size5">SGST(<?php echo $sgst; ?>%)</h6>
                                  <span class="box-design"><?php echo $sgst_amount=((float)$total_amount/100)*$sgst; ?></span>
                                </div>
                                <?php    
                               }
                               ?>
                               ...
                               <div class="d-flex justify-content-between">
                                  ...
                                  <span class="box-design"><?php echo number_format($net_amount-$total, 2); ?></span>
                               </div> 
                               <div class="d-flex justify-content-between">
                                  <h6 class="rights-brs fonts-size6"><b>NET AMOUNT($)</b></h6>
                                  <span class="box-design"><?php echo number_format($net_amount,2); ?></span>
                               </div> 
                         <!--      <div class="d-flex">-->
