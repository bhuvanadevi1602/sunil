...
@media print{
 #invoice-table{
        ...
        #invoice-table th, td { font-weight: bold; }
        #invoice-table th:first-child, td:first-child { border-left: none; }
        #invoice-table th {font-size:14px !important;font-weight:bold;  }
            ...
            <div class="container-fluid" style="margin-top: 10px;">
                ...
                <div class="row">
                    <div class="col-lg-12" style="font-family: 'PT Serif', serif !important;">
                        <table class="table tablesss"  id="invoice-table" style="border: 1px solid;margin-top:15px;">
                            <thead>
                                <tr>
                                    <th class="text-center pt-1 pb-1" colspan="10"><h4  style="line-height: 10px;"><b><u>CASH BILL REPORT </u></b></h4></td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr class="table-titless invoice_line">
                                    ...
                                    <td class="text-center"><?php echo $rec['bill_id']; ?></td>
