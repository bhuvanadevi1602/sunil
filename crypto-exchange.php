                                ...
                                <div class="card-body">     
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="Dollor_ex" role="tabpanel" data-simplebar="" style="height: 210px;"> 
                                            <ul class="list-unsyled m-0 ps-0 mt-1">
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/btc.png" alt="" class="me-1" height="20">BTC-USD</a>
                                                    <span class="text-muted">$1420.00</span>
                                                    <span class="text-danger">-0.2%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/eth.png" alt="" class="me-1" height="20">ETH-USD</a>
                                                    <span class="text-muted">$233.00</span>
                                                    <span class="text-success">0.28%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dash.png" alt="" class="me-1" height="20">BCH-USD</a>
                                                    <span class="text-muted">$12.00</span>
                                                    <span class="text-success">0.12%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/mon.png" alt="" class="me-1" height="20">BSV-USD</a>
                                                    <span class="text-muted">$95.00</span>
                                                    <span class="text-danger">-0.22%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/lite.png" alt="" class="me-1" height="20">LTC-USD</a>
                                                    <span class="text-muted">$32.00</span>
                                                    <span class="text-danger">-0.09%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/qub.png" alt="" class="me-1" height="20">BNB-USD</a>
                                                    <span class="text-muted">$51.00</span>
                                                    <span class="text-success">0.27%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dollar.png" alt="" class="me-1" height="20">ADA-USD</a>
                                        ...
                                        <div class="tab-pane" id="BTC_ex" role="tabpanel" data-simplebar="" style="height: 210px;">  
                                            <ul class="list-unsyled m-0 ps-0 mt-1">
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/btc.png" alt="" class="me-1" height="20">BTC-BTC</a>
                                                    <span class="text-muted">0.000041</span>
                                                    <span class="text-danger">-0.2%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/eth.png" alt="" class="me-1" height="20">ETH-BTC</a>
                                                    <span class="text-muted">0.0000411</span>
                                                    <span class="text-success">0.28%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dash.png" alt="" class="me-1" height="20">BCH-BTC</a>
                                                    <span class="text-muted">0.0000652</span>
                                                    <span class="text-success">0.12%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/mon.png" alt="" class="me-1" height="20">BSV-BTC</a>
                                                    <span class="text-muted">0.0000120</span>
                                                    <span class="text-danger">-0.22%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/lite.png" alt="" class="me-1" height="20">LTC-BTC</a>
                                                    <span class="text-muted">0.00001141</span>
                                                    <span class="text-danger">-0.09%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/qub.png" alt="" class="me-1" height="20">BNB-BTC</a>
                                                    <span class="text-muted">0.000096</span>
                                                    <span class="text-success">0.27%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dollar.png" alt="" class="me-1" height="20">ADA-BTC</a>
                                        ...
                                        <div class="tab-pane" id="ETH_ex" role="tabpanel" data-simplebar="" style="height: 210px;">  
                                            <ul class="list-unsyled m-0 ps-0 mt-1">
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/btc.png" alt="" class="me-1" height="20">BTC-ETH</a>
                                                    <span class="text-muted">0.000096</span>
                                                    <span class="text-danger">-0.2%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/eth.png" alt="" class="me-1" height="20">ETH-ETH</a>
                                                    <span class="text-muted">0.000016</span>
                                                    <span class="text-success">0.28%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dash.png" alt="" class="me-1" height="20">BCH-ETH</a>
                                                    <span class="text-muted">0.000044</span>
                                                    <span class="text-success">0.12%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/mon.png" alt="" class="me-1" height="20">BSV-ETH</a>
                                                    <span class="text-muted">0.0003254</span>
                                                    <span class="text-danger">-0.22%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/lite.png" alt="" class="me-1" height="20">LTC-ETH</a>
                                                    <span class="text-muted">0.00009621</span>
                                                    <span class="text-danger">-0.09%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1 border-bottom">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/qub.png" alt="" class="me-1" height="20">BNB-ETH</a>
                                                    <span class="text-muted">0.00009965</span>
                                                    <span class="text-success">0.27%</span>
                                                </li>
                                                <li class="align-items-center d-flex justify-content-between py-1">
                                                    <a href="#" class="my-1"><img src="assets/images/logos/dollar.png" alt="" class="me-1" height="20">ADA-ETH</a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">                                        
                                    ...
                                    <div class="row">                                        
                                        <div class="col">                                           
                                            <div class="media">
                                                <img src="assets/images/logos/btc.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
                                                    <h6 class="m-0">BTC</h6>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">                                          
                                    ...
                                    <div class="row">                                        
                                        <div class="col">                                           
                                            <div class="media">
                                                <img src="assets/images/logos/eth.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
                                                    <h6 class="m-0">ETH</h6>
