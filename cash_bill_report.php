                    ...
                    <div class="col-12 " >
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title col-11">Cash Bill Report</h4>
...
<script>
    $(document).ready(function(){
        ...
        $('#filter_invoice').on('click',function(){
             ...
             table.ajax.url('ajax_request.php?action=fetch_cash_bill_report&from_date='+from_date+'&to_date='+to_date).load();
             
             table.ajax.reload();
             
             $.ajax({
                 url:'ajax_request.php?action=fetch_cash_bill_subtotal',
                 type:'POST',
                 dataType:'json',
    ...
    $('#print_report').on('click',function(){
        ...
        window.open('cash_bill_report1.php?from_date='+from_date+'&to_date='+to_date);
