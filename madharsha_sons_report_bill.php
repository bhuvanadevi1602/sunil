...
#invoice-table {
        ...
        #invoice-table th {font-size:9pt !important;  }
                ...
                <div class="row">
                    <div class="col-lg-12" style="font-family: 'PT Serif', serif !important;">
                        <table class="table tablesss" id="invoice-table" style="border: 1px solid;">
                            <thead>
                                <tr>
                                    <th class="text-center pt-1 pb-1" colspan="10"><h4 style="line-height: 10px;"><b><u>Madharsha & Sons REPORT </u></b></h4></td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr class="table-titless invoice_line" >
                                    ...
                                    <td class="text-center" style="white-space:nowrap;"><?= date('d-m-Y',strtotime($rec['created_at'])) ?></td>
